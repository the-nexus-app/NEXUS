...
- `Auto theme color` based on each entry's cover.
- `App custom theme` with `Color palettes`.
...
* Lewd filter and tracking filter for your library.
* Custom categories for sources.
* Manga info edit, cover view, and share/save.
* Source migration between sources.
